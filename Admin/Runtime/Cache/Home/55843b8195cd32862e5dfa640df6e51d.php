    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0);">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">超级管理员</strong></span>
                                <!--<span class="text-muted text-xs block">其他操作<b class="caret"></b></span>-->
                                </span>
                            </a>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">美文管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Beautifulwords/w_list');?>">美文列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Beautifulwords/w_add');?>">上传美文</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Author/a_list');?>">作者列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Author/a_add');?>">添加作者</a>
                            </li>
                        </ul>
                   ...
                   <!-- <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Members/hobby');?>">兴趣管理</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Banner/b_list');?>">banner列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Banner/b_add');?>">banner添加</a>
                            </li>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('right');?>" frameborder="0" data-id="index_right" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 芝麻读书后台管理</div>
            </div>
        </div>
    </div>
    </body>
