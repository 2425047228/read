...
<head>
    ...
    <div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" action="/admin.php/Home/Login/Login/login/message/Login/login?message=%E9%AA%8C%E8%AF%81%E7%A0%81%E9%94%99%E8%AF%AF%EF%BC%81" name="login">
                    <h4 class="no-margins">登录：</h4>
                    <p class="m-t-md" id="notice"><?php echo ($_GET['message']); ?></p>
                    <input type="text" class="form-control uname" placeholder="用户名" name="account" id="account"/>
